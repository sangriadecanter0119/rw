...
(function($) {
    ...
    var methods = {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "funcCall":
                        ...
                        break;
                    case "rateSumUp":
                        errorMsg = methods._rateSumUp(field, rules, i, options);
                        break;
         ...
         * @return an error string if validation failed
         */
        _rateSumUp: function(field, rules, i, options) {
            var equalsField = rules[i + 1];

            if (parseFloat(field.val())+ parseFloat($("#" + equalsField).val()) != parseFloat("100.00")){
                return options.allrules.rateSumUp.alertText;
            }
            //if no errors,close error prompt of counterpart field
            methods._closePrompt($("#" + equalsField));
        },
        /**
