...
<tr>
    ...
    <td><textarea id="special_note" class="small-inputcomment " name="data[EstimateTrn][note]" style="height:20px;" ></textarea></td>
...
<tr>
    ...
    <td><textarea id="summary_note" class="small-inputcomment " name="data[EstimateTrn][summary_note]" style="height:20px;" ></textarea></td>
</tr>
</table>
<div class="submit">
